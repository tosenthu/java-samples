...
public class PositionalBubbleSort {
	...
	private static void bubbleSort(int[] arrayElements) {
		for (int i = PositionalBubbleSort.ODD_POSITION_SORT ? 0 : 1; i < (arrayElements.length - 1); i += 2) {
	...
	public static void main(String[] args) {
		...
		PositionalBubbleSort.bubbleSort(arrayElements);
